...
// Don't duplicate me!
if ( ! class_exists( 'ReduxFramework_Extension_custom_badges' ) ) {

    /**
     * Main ReduxFramework_Extension_custom_badges class
     *
     * @since       1.0.0
     */
    class ReduxFramework_Extension_custom_badges {
        ...
        public function render() {
            ...
            echo '<a href="javascript:void(0);" class="button button-primary redux-custom-badges-add" data-add_number="' . $this->field['add_number'] . '" data-id="' . $this->field['id'] . '-ul" data-name="' . $this->field['name'] . $this->field['name_suffix'] . '[]">' . $this->add_text . '</a><br/>';
        }
