...
(function( $ ) {
    ...
    redux.field_objects.badge_color = redux.field_objects.badge_color || {};
    ...
    redux.field_objects.badge_color.init = function( selector ) {

        if ( !selector ) {
            selector = $( document ).find( ".redux-group-tab" ).find( '.redux-container-custom_badges' );
        }
