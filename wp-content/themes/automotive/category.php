<?php get_header(); 
    ...
    $sidebar            = (isset($awp_options['category_page_sidebar_position']) && !empty($awp_options['category_page_sidebar_position']) ? $awp_options['category_page_sidebar_position'] : "");
    $default_sidebar    = (isset($awp_options['category_page_sidebar']) && !empty($awp_options['category_page_sidebar']) ? $awp_options['category_page_sidebar'] : "");     
