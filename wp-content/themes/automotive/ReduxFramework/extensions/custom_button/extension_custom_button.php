...
// Don't duplicate me!
if( !class_exists( 'ReduxFramework_extension_custom_button' ) ) {
     ...
     * @since       3.1.6
     */
    class ReduxFramework_extension_custom_button extends ReduxFramework {
